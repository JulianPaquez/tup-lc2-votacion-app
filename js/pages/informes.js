...
let informesContainer = document.getElementById("informe-container");
let cuadritos = document.getElementById("cuadritos");
let mesasEscrutadas = document.getElementById("mesas-escrutadas");
...
document.addEventListener("DOMContentLoaded", async () => {
  if (localStorage.getItem("INFORMES")) {
    ...
    mostrarMensaje(
      mensajeAmarillo,
      "Debe agregar un INFORME desde Paso o Generales primero!"
    );
  }
});
